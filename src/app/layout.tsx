...
export const metadata: Metadata = {
  metadataBase: new URL('https://vautikaphysiotherapy.com'),
  title: {
  ...
  authors: [{ name: 'Dr. Satya Mohanty (PT)', url: 'https://vautikaphysiotherapy.com' }],
  ...
  alternates: {
    canonical: 'https://vautikaphysiotherapy.com',
  },
  verification: {
