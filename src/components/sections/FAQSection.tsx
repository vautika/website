        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-2xl p-6">
              <h3 className="font-display font-bold text-primary-900 dark:text-primary-300 mb-2">
              ...
              <div className="flex flex-wrap gap-2">
                <a href="tel:+917381455744" className="btn-primary text-sm py-2 px-4">
                  Call Us
                </a>
                <a
          ...
          <div className="space-y-3">
            {faqs.map(({ q, a }, i) => (
              ...
              >
                ...
                >
                  <span className="font-display font-semibold text-gray-900 dark:text-white text-sm">
                    {q}
                  </span>
                  <ChevronDown
                    className={`w-4 h-4 text-primary-900 dark:text-primary-300 shrink-0 transition-transform duration-300 ${
                      open === i ? 'rotate-180' : ''
                    }`}
                  />
                </button>
