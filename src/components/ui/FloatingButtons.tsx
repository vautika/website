  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 no-print" role="complementary" aria-label="Quick contact buttons">
      ...
      <a
        ...
        className="group w-14 h-14 text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:-translate-y-1"
      ...
      <a
        ...
        className="group w-14 h-14 bg-primary-900 hover:bg-primary-800 text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:-translate-y-1"
      >
