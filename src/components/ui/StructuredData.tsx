    ...
    '@graph': [
      {
        ...
        '@id': 'https://vautikaphysiotherapy.com/#organization',
        name: 'Vautika Physiotherapy & Rehabilitation Centre',
        alternateName: 'Vautika Physio',
        url: 'https://vautikaphysiotherapy.com',
        logo: {
          '@type': 'ImageObject',
          url: 'https://vautikaphysiotherapy.com/images/logo.svg',
        },
        description:
      ...
      {
        '@type': 'Physician',
        '@id': 'https://vautikaphysiotherapy.com/#physician',
      ...
      {
        '@type': 'WebSite',
        '@id': 'https://vautikaphysiotherapy.com/#website',
        url: 'https://vautikaphysiotherapy.com',
        name: 'Vautika Physiotherapy & Rehabilitation Centre',
        ...
        potentialAction: {
          ...
          target: {
            '@type': 'EntryPoint',
            urlTemplate: 'https://vautikaphysiotherapy.com/search?q={search_term_string}',
          },
